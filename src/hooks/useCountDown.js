/**
 * @usage: const [timeLeft, actions] = useCountDown(timeToCount, interval); timeToCount and interval has unit milliseconds
 * @refs: https://www.npmjs.com/package/react-countdown-hook
 */
